 ...
 *
 * 2003-August-27   Jason Rohrer
 * Created.
 *
 * 2003-August-28   Jason Rohrer
 * Fixed bug in user message input.
 *
 * 2003-August-29   Jason Rohrer
 * Improved timing of receive message output.
 * Fixed print timing of prompt.  Fixed deletion bug.
 * Added support for fetching contact info by virtual address.
...
int main() {
    ...
    while( !quitting ) {
        ...
        // lock while we handle this user action
        printMessageLock->lock();
