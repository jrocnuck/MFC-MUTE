...
//////////////////////////////////////////////////////////////////////
//
// 2 functions are useful when icons are in external .ico files
//  
//////////////////////////////////////////////////////////////////////



bool CIconStatic::SetText(CString strText,CString strFilePath)
{
	m_strText = strText;
    SetIcon(strFilePath);
	return true;
...
bool CIconStatic::SetIcon(CString strFilePath)
{
	CString strText;	
	GetWindowText(strText);
	SetWindowText("");
    ...
    DrawState( MemDC.m_hDC, NULL, NULL,
		(LPARAM)LoadImage(0, strFilePath, IMAGE_ICON, 16, 16,LR_LOADFROMFILE /*|LR_SHARED*/), // added LR_SHARED to make the icon handle reusable
		// i_a: long --> LPARAM -- reduce number of warnings in VC7
		NULL, 3, 0, 16, 16, DST_ICON | DSS_NORMAL);
